...
def export(data, filename, schematics_folder, log, override_ass=False):
    ...
    path = join(schematics_folder, name+'.litematic')
    schem.save(path)
    log('Successfully exported to %s' %path)
